...
const areaClasses = [
  "col-start-2 col-end-3 row-start-1 row-end-3", // index 0
  "col-start-1 col-end-2 row-start-2 row-end-4", // index 1
  "col-start-1 col-end-2 row-start-4 row-end-6", // index 2
  "col-start-2 col-end-3 row-start-3 row-end-5", // index 3
];
...
>(({ transition, ...props }, ref) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{
        staggerChildren: (transition as { staggerChildren?: number })?.staggerChildren ?? 0.2,
